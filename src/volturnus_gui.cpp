...
{
    sendAccMessage("menu", "cancel"); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "display"); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 0); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 1); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 3); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 8); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 8); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 8); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "cancel_submenu"); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 6); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 6); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 6); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "cancel_submenu"); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 5); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 5); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 5); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "cancel_submenu"); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 8); Sleeper::msleep(MENU_SLEEP);
    ...
    sendAccMessage("menu", "select", 8); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "cancel_submenu"); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 7); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 7); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 7); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "cancel_submenu"); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", 6); Sleeper::msleep(MENU_SLEEP);
...
void rqt_volturnus::volturnus_gui::on_video_menu_dateButton_released()
{
    ...
    now.addMSecs(1600);
    // Day
    sendAccMessage("menu", "select", now.date().day()/10); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", now.date().day()%10); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "cancel_submenu"); Sleeper::msleep(MENU_SLEEP);

    // Month
    sendAccMessage("menu", "select", now.date().month()/10); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", now.date().month()%10); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "cancel_submenu"); Sleeper::msleep(MENU_SLEEP);

    // Year
    int yy = now.date().year()-2000;
    sendAccMessage("menu", "select", yy/10); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", yy%10); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "cancel_submenu"); Sleeper::msleep(MENU_SLEEP);

    // Hours
    sendAccMessage("menu", "select", now.time().hour()/10); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", now.time().hour()%10); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "cancel_submenu"); Sleeper::msleep(MENU_SLEEP);

    // Minutes
    sendAccMessage("menu", "select", now.time().minute()/10); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", now.time().minute()%10); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "cancel_submenu"); Sleeper::msleep(MENU_SLEEP);

    // Seconds
    sendAccMessage("menu", "select", now.time().second()/10); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "select", now.time().second()%10); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "cancel_submenu"); Sleeper::msleep(MENU_SLEEP);
    sendAccMessage("menu", "cancel");
}
